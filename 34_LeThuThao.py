...
def print_student_list():
    ...
    - Nếu không, in ra thông tin sinh viên theo định dạng:
...
def search_student(search_name):
    ...
    - Tìm kiếm trong `student_list` tất cả sinh viên có tên (không phân biệt hoa thường)
      chứa `search_name`.
    - In ra thông tin sinh viên tìm thấy.
    - Nếu không có kết quả, in "Khong tim thay sinh vien nao.".
    """
